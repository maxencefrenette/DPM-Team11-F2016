...
/**
 * This class initializes all the sensors and motors and handles the eventual exceptions that could arise.
 * 
...
public class HardwareInitializer {
	...
	/**
	 * Initializes a single motor and manages initialization errors. If an exception is thrown, it will try again up to
	...
	/**
	 * Initializes a single color sensor and manages initialization errors. If an exception is thrown, it will try again
	 * up to a maximum number of trials.
	 * 
	...
	/**
	 * Initializes a single ultrasonic sensor and manages initialization errors. If an exception is thrown, it will try
	 * again up to a maximum number of trials.
	 * 
